...
export default function Column({ title, status, tasks, onDropCard, onEdit, onDuplicate, onDelete, onChangeState }) {
      ...
      <div className="space-y-3">
        {tasks.map((t, i) => (
          <Card
            ...
            draggableProps={{
              draggable: true,
              onDragStart: (e) => e.dataTransfer.setData("text/plain", `${t.id}|${i}`),
            }}
          />
        ))}
      </div>
